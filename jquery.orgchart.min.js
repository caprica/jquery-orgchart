...
c.addClass("hiddenChildren"),d.interactive&&c.hover(function(){a(this).addClass(d.hoverClass)},function(){a(this).removeClass(d.hoverClass)}));var l=a("<tr/>").addClass("lines v");e.each(function(){var c=a("<td/>").addClass("line left top"),d=a("<td/>").addClass("line right top");l.append(c).append(d)});l.find("td:first").removeClass("top");l.find("td:last").removeClass("top");j.append(l);var r=a("<tr/>");e.each(function(c){var b=a("<td/>");b.attr("colspan",2);m(a(this),b,g+1,c,d);r.append(b)});j.append(r)}else d.stack&&
(e=e.clone(),e=a("<ul class='stack'>").append(e),e=a("<div class='stack-container'>").append(e),c.after(e));-1<d.showLevels&&g>=d.showLevels-1&&n.nextAll("tr").hide();p.append(j);f.append(p)}a.fn.orgChart=function(b){var f=a.extend({},a.fn.orgChart.defaults,b);return this.each(function(){$this=a(this).clone();-1<f.levels&&$this.find("ul").andSelf().filter(function(){return a(this).parents("ul").length+1>f.levels}).remove();var b=a("<div class='"+f.chartClass+"'/>");f.interactive&&b.addClass("interactive");
$this.is("ul")?m($this.find("li:first"),b,0,0,f):$this.is("li")&&m($this,b,0,0,f);b.find("div.node a").click(function(a){a.stopImmediatePropagation()});f.container.append(b)})};a.fn.orgChart.defaults={container:a("body"),depth:-1,levels:-1,showLevels:-1,stack:!1,chartClass:"orgChart",hoverClass:"hover",nodeText:function(a){return a.clone().children("ul,li").remove().end().html()},interactive:!1,fade:!1,speed:"slow",nodeClicked:function(){},copyClasses:!0,copyData:!0,copyStyles:!0,copyTitle:!0}})(jQuery);
